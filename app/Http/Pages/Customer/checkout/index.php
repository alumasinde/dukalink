...
$root = dirname(__DIR__, 5); require $root.'/vendor/autoload.php'; use function App\Support\e; $title='Checkout'; ob_start(); ?>
...
<script>window.DUKAME_STORE={slug:<?= json_encode(trim((string)($_GET['shop']??''))) ?>}; window.DUKAME_CHECKOUT_PAGE=true;</script>
