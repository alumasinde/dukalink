...
$labels = ['order_created' => 'Order received', 'order_confirmed' => 'Order confirmed', 'order_preparing' => 'Order preparing', 'order_ready' => 'Order ready', 'order_delivered' => 'Order delivered', 'order_cancelled' => 'Order cancelled', 'payment_received' => 'Payment received', 'payment_failed' => 'Payment failed'];
...
ob_start(); ?>
<div class="merchant-shell"><?php require $root . '/app/Views/components/merchant-sidebar.php'; ?><main class="merchant-main">
        ...
        </div><?php require $root . '/app/Views/components/alert.php'; ?>
